...
Charity.create([
	...
	{name: 'Fractured Atlas'}, {name: 'Community Partnership for Arts and Culture'}, {name: 'The Seattle Public Library Foundation', avatar: File.open('app/assets/images/the_seattle_public_library_foundation.png', 'rb'), url: "http://foundation.spl.org/"}, {name: 'Walking Mountains Science Center', avatar: File.open('app/assets/images/walking_mountains_science_center.jpg', 'rb'), url: "http://www.walkingmountains.org/"}, {name: 'Manhattan Theatre Club'}, #Arts, Culture, Humanities
